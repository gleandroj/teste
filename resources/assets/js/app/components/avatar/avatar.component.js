...
avatarComponentController.$inject = ['$scope'];

export let avatarComponent = {
    selector: 'appAvatar',
    bindings: {
        url:'<',
        width:'@',
